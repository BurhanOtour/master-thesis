...
%%%%%%%%%
\title{Space Reduction of Tentris Hypertrie with Path Compression}
\author{Burhan Otour}
...
\supervisor{Prof. Dr. Axel-Cyrille Ngonga Ngomo\\Prof. Dr. Stefan Böttcher\\Alexander Bigerl}
\submissiondate{September 15, 2020}
