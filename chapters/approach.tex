...
That is the frequently accessed key paths suffixes stored at the root node in array-based containers will increase the probability that those paths resides within cache. 
...
\todo{ALEX: Why using tagged pointer for internal nodes saves space}
