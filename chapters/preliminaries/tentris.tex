...
Consequently, the engine can execute SPARQL queries containing the following keywords: \verb|@prefix|, \verb|SELECT|, \verb|WHERE|, and \verb|DISTINCT|\cite{Hitzler}. \myworries{mention that you omit talking about the query aspects: Einstein summation, etc} \\
